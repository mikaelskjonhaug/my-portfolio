...
export default function AboutMe() {
  ...
  <div className="space-y-0">
        <div>
          <h3 className="text-accent text-xl font-semibold mb-0 text-left">Languages</h3>
          <ul className="flex flex-wrap justify-start gap-3">
            {languages.map((lang) => (
              <li key={lang.name} className="flex items-center gap-1 mb-0">
        ...
        <div>
          <h3 className="text-accent text-xl font-semibold mb-0 text-left">Frameworks / Libraries</h3>
          <ul className="flex flex-wrap justify-start gap-3">
            {frameworks.map((fw) => (
              <li key={fw.name} className="flex items-center gap-1 mb-0">
        ...
        <div>
          <h3 className="text-accent text-xl font-semibold mb-0 text-left">Tools &amp; Databases</h3>
          <ul className="flex flex-wrap justify-start gap-3">
            {tools.map((tool) => (
              <li key={tool.name} className="flex items-center gap-1 mb-0">
